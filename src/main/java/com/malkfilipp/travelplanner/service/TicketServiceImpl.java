...
public class TicketServiceImpl implements TicketService {
    ...
    @Override
    public Iterable<Ticket> getTickets(String arrival, String departure, Date date) {
        ...
        return ticketRepository.findTickets(arrival, departure, startTime, endTime);
        //TODO: can be null, is it problem?
    }
}
